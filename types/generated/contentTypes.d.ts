...
export interface ApiEmployeeDetailEmployeeDetail
  extends Struct.CollectionTypeSchema {
  collectionName: 'employee_details';
  info: {
    displayName: 'employee detail';
    pluralName: 'employee-details';
    singularName: 'employee-detail';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    job_position: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::employee-detail.employee-detail'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiExtraLinkExtraLink extends Struct.CollectionTypeSchema {
  collectionName: 'extra_links';
  info: {
    displayName: 'extra link';
    pluralName: 'extra-links';
    singularName: 'extra-link';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFlyerSectionFlyerSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'flyer_sections';
  info: {
    displayName: 'flyer section';
    pluralName: 'flyer-sections';
    singularName: 'flyer-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::flyer-section.flyer-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGalleryDetailGalleryDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    thumbnail_path: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInfoDetailInfoDetail extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::employee-detail.employee-detail': ApiEmployeeDetailEmployeeDetail;
      'api::extra-link.extra-link': ApiExtraLinkExtraLink;
      'api::field.field': ApiFieldField;
      'api::flyer-section.flyer-section': ApiFlyerSectionFlyerSection;
